...
contract LottoBalls is IERC20, ERC20, VRFConsumerBase, ILottoBalls {
    ...
    constructor(
        ...
        bonus = 100000; // first 100k plays get 5x
    ...
    function begin() external override onlyOwner {
      ...
      _mint(msg.sender, uint256(4000000).mul(Bone));
      initialized = true;
    ...
    //
    // @notice returns DAI balance of this contract 
    // 
